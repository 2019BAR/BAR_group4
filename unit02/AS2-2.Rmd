...
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("1983-01-01","1983-12-31")),col='gray',lty=3)
```
...
lines(CO$Date, CO$StockPrice, type='l', col='green')
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("2000-03-01","2000-03-31")),col='gray',lty=3)
```
...
lines(CO$Date, CO$StockPrice, type='l', col='green')
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("1995-01-01","2005-12-31")),col='gray',lty=3)
```
...
lines(CO$Date, CO$StockPrice, type='l', col='green')
lines(PG$Date, PG$StockPrice, type='l', col='blue')
abline(v=as.Date(c("1997-09-01","1997-11-31")),col='gray',lty=3)
