...
#131302
#
A = read.csv('C:/BAR_Group4/CPSData.csv')
MetroAreaMap = read.csv("C:/BAR_Group4/MetroAreaCodes.csv")
CountryMap = read.csv("C:/BAR_Group4/CountryCodes.csv")
nrow(A)
```
...
```{r}
#American Indian、Multiracial、Black、White
#
...
```{r}
#小組討論為什麼要用這四個，代表？
#由於題目要問的是相關性且是系統性的相關問題，因此用此四個變數來看和Married的相關是屬於何者，藉由數值也可得知：年齡資料和Married有系統性的缺項問題，在14歲之前是沒有辦法結婚的，因此可藉由數值得知合理為系統性缺項。
#Age
